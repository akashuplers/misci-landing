            ...
            Object.keys(newsLetter).map(async (key: string) => {
                try {
                    if(key === "wordpress") {
                        ...
                        if(key === 'twitter') {
                            text = `Please act as an expert Twitter to write a Twitter Tweet under 240 characters:
                            Topic of Tweet is "${title}".
                            Embed this line at the end of the tweet - "This tweet was generated by @Lille_AI"`
                        }
