...
interface Props { showModal: boolean, setShowModal: (showModal: boolean) => void }
export default function GoogleDriveModal({ showModal, setShowModal} : Props) {
                        ...
                        <div className="w-full h-full p-6 bg-white rounded-lg flex-col justify-center items-start gap-8 inline-flex">
                            ...
                            <div className="w-full h-full flex-col justify-start items-start gap-6 flex">
                                <div className="self-stretch h-full flex-col justify-start items-start gap-1 flex">
                                    ...
                                    <input className="self-stretch h-11 p-5 bg-white rounded-lg border border-neutral-200 flex-col justify-center items-start gap-[15px] flex" placeholder="e.g. https://drive.google.com/drive/folders/1UJ7T8n2Ql6q6nX7Xzg2F0Z4S7QZl5Yt2" />
                                ...
                                <div className="self-stretch h-full flex-col justify-start items-start gap-1 flex">
                                    ...
                                    <div className="self-stretch h-11 flex-col justify-start items-start gap-1 flex">
                                        <input className="self-stretch h-11 p-5 bg-white rounded-lg border border-neutral-200 flex-col justify-center items-start gap-[15px] flex" placeholder="e.g. Kiransingl434a@gmail.com" />
                                    </div>
                                </div>
                            </div>
