          ...
          <div className=" relative mx-auto max-w-screen-xl flex flex-col">
            ...
            >
              ...
              >
                <RotatingText/> 
                <div
                  className="w-full lg:min-w-[850px] lg:max-w-[850px] h-full opacity-90 transition-all ease-out shadow border border-white backdrop-blur-[20px] flex-col justify-center mt-10 items-center gap-[18px] inline-flex rounded-[10px] p-4"
                  style={{
                      ...
                      <Tab.Panels>
                        {tabs.map((tab) => (
                          <Tab.Panel
                            key={tab.id}
                            className={`
                            ${activeTab === tab.id ? "block" : "hidden"} p-2`}
                          >
