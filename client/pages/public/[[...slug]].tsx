...
function Page({
  ...
  useEffect(() => {
    ...
    if (publishContainer != null) {
      ...
      <a href="javascript:history.go(-2)" class="hover:bg-orange-200 p-2 rounded-full flex items-center gap-2 transition duration-300" style="display: flex; justify-content: flex-start; align-items: center; gap: 8px; width: fit-content;">
