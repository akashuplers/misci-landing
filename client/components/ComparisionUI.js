      ...
      <div className="z-10 relative max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          {[
            ...
            <div
              key={index}
              className="hover:bg-[#F4928A] hover:text-white transition duration-300 p-4 rounded-lg"
            >
              <p>{feature}</p>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            {
              name: "🌍 ChatGPT",
              description: "Tailored for chat & hallucinations.",
              price: "$20/month",
            },
            {
              name: "⚙️ Jasper",
            ...
            <div
              key={index}
              className="bg-[#E9C403] text-black p-4 rounded-lg hover:shadow-lg transition duration-300"
            >
        ...
        <div className="bg-[#F4928A] mt-12 p-8 rounded-lg text-center">
          ...
          <p>
            Craft, refine, and shine with Lille.ai. Embrace a transformative
            content journey, tailored just for you.
          </p>
          <button
            onClick={onPress}
            className="mt-4 bg-gradient-to-r from-[#4939FA] via-[#402fff] to-[#0a4bfc] text-white py-2 px-6 rounded-full text-lg font-semibold shadow-lg transform hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out"
          >
